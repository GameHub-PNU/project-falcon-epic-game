...
void SecondLevelGameScene::initPlaneAndBackgroundPosition()
{
	...
	background_sprite->runAction(Sequence::create(DelayTime::create(1.0f), CallFunc::create(CC_CALLBACK_0(SecondLevelGameScene::turnOnMusic, this)),
...
{
     soundId = experimental::AudioEngine::play2d("backgroundSongLevel2.mp3", true, SettingsHandler::getSoundVolume());
...
bool SecondLevelGameScene::onCollision(PhysicsContact& contact)
{
	...
	{
		// Програш
		plane_sprite->runAction(Sequence::create(planeCrush, CallFuncN::create(CC_CALLBACK_1(SecondLevelGameScene::goToGameOverScene, this)), nullptr));
		return false;
	}
