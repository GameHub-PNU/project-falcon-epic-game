...
void ThirdLevelGameScene::initPlaneAndBackgroundPosition()
{
	...
	background_sprite->runAction(Sequence::create(DelayTime::create(1.0f), CallFunc::create(CC_CALLBACK_0(ThirdLevelGameScene::turnOnMusic, this)),
...
{
	soundId = experimental::AudioEngine::play2d("backgroundSongLevel3.mp3", false, SettingsHandler::getSoundVolume());
...
bool ThirdLevelGameScene::onCollision(PhysicsContact& contact)
{
	...
	{
		// Програш
		plane_sprite->runAction(Sequence::create(planeCrush, CallFuncN::create(CC_CALLBACK_1(ThirdLevelGameScene::goToGameOverScene, this)), nullptr));
		return false;
	}
